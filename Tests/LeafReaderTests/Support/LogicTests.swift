...
private let tests: [(String, () throws -> Void)] = [
    ...
    ("NaturalLanguage German verb characterization", GermanLemmaFixtureTests.testVerbInflectionBaseline),
    ("NaturalLanguage German sentence characterization", GermanLemmaFixtureTests.testVerbInflectionInSentenceBaseline),
    ("NaturalLanguage German noun characterization", GermanLemmaFixtureTests.testNounPluralBaseline),
    ("NaturalLanguage German disambiguation characterization", GermanLemmaFixtureTests.testNounVerbDisambiguationBaseline),
    ...
    ("German form label owned noun evidence", GermanFormLabelerTests.testOwnedNounMorphologyDoesNotDependOnApplePOS),
    ...
    ("DOCX streaming formatting and TOC", DOCXLogicTests.testStreamingRendererPreservesFormattingAndTOC),
    ("DOCX malformed XML fails", DOCXLogicTests.testMalformedDocumentXMLFails),
