...
package struct VocabularyAssessmentEvaluationRequest {
    package let seed: UInt64
    package let readers: Int
    package let lemmas: Int
    package let documents: Int
    package let itemResidualStandardDeviation: Double
    package let responseNoiseRate: Double
    package let idiosyncraticFlipRate: Double
    package let evidenceReliabilityScale: Double
    package let minimumEpsilonKnowledge: Double
    package let difficultyPriorStandardDeviationScale: Double
    package let coverageQuantile: Double
    package let warmPriorWeight: Double
    package let coverageStoppingComputation: String
    ...
    package let usesPairedDiagnosticSubstreams: Bool

    package init(
        seed: UInt64, readers: Int, lemmas: Int, documents: Int,
        itemResidualStandardDeviation: Double, responseNoiseRate: Double,
        idiosyncraticFlipRate: Double, evidenceReliabilityScale: Double,
        minimumEpsilonKnowledge: Double, difficultyPriorStandardDeviationScale: Double,
        coverageQuantile: Double, warmPriorWeight: Double,
        coverageStoppingComputation: String, adaptiveLossPopulation: VocabularyAdaptiveLossPopulation,
        questionObjective: VocabularyQuestionObjective, usesPairedDiagnosticSubstreams: Bool
    ) {
        self.seed = seed
        self.readers = readers
        self.lemmas = lemmas
        self.documents = documents
        self.itemResidualStandardDeviation = itemResidualStandardDeviation
        self.responseNoiseRate = responseNoiseRate
        self.idiosyncraticFlipRate = idiosyncraticFlipRate
        self.evidenceReliabilityScale = evidenceReliabilityScale
        self.minimumEpsilonKnowledge = minimumEpsilonKnowledge
        self.difficultyPriorStandardDeviationScale = difficultyPriorStandardDeviationScale
        ...
        self.usesPairedDiagnosticSubstreams = usesPairedDiagnosticSubstreams
    }

    fileprivate var populationParameters: PopulationParameters {
    ...
    fileprivate var assessmentModelParameters: AssessmentModelParameters {
    ...
    fileprivate var effectiveDocumentCount: Int { min(documents, readers) }
}

package struct VocabularyAssessmentEvaluationArtifacts {
...
package func runVocabularyAssessmentEvaluation(
    _ arguments: VocabularyAssessmentEvaluationRequest
) throws -> VocabularyAssessmentEvaluationArtifacts {
    ...
    return VocabularyAssessmentEvaluationArtifacts(
        jsonData: data,
