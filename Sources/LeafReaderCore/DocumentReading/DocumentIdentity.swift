...
package enum DocumentIdentity {
    package static func fastID(for url: URL) -> String {
    ...
    package static func legacyCacheKey(for url: URL) -> String {
    ...
    package static func selectedID(fastID: String, legacyID: String?, legacyHasData: Bool, fastHasData: Bool) -> String {
