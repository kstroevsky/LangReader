...
echo "==> Checking sealed historical post-cleanup development-confirmation reservation"
...
echo "==> Checking sealed cross-format candidate-identity development-confirmation reservation"
